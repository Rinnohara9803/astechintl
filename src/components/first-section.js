    ...
    <div className="flex flex-col md:flex-row gap-x-5 lg:flex-row py-4 px-10 md:px-16 lg:px-36 md:py-20 pb-10  relative ">
      ...
      {windowWidth > 800 && (
        <img
          ...
          className="header-image-1 absolute object-cover right-0 top-10 rounded-tl-3xl rounded-bl-3xl bg-white z-10"
      ...
      <div className=" sm:w-full md:w-1/2 flex flex-col items-start">
        ...
        <p className=" heading-text-1 text-3xl font-bold text-white py-3">
          {" "}
          IT Services
        </p>
        <p className=" heading-text-2 text-sm font-semibold text-white">
          {" "}
      ...
      {windowWidth > 800 && (
        <div className="sm:w-full md:w-1/2  flex flex-row justify-start md:justify-center relative">
